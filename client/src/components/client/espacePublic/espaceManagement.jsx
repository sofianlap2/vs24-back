...
const EspacesManagementClient = () => {
  ...
  useEffect(() => {
    // Function to fetch espaces data
    const fetchEspaces = async () => {
      try {
        ...
        // Map response data to include a unique identifier `id`
    ...
    // Fetch espaces data if email is provided
    if (email) {
      fetchEspaces();
    }
  }, [email, appUrl, tokenValue]);
