            ...
            <div style={{ display: "flex" }}>
                ...
                <div className="row">
                    <div style={{ width: "90vw" }}>
                        ...
                        >
                            <h3 style={{ fontFamily: 'Constantia', fontWeight: 'bold' }}>Modification la station</h3>
                            <br />
                            <ToastContainer />
                            <div className="col-md-4">
                                <label className="form-label" style={{ fontFamily: 'Constantia', fontWeight: 'bold' }}>Référence:</label>
                                <input
                                    type="text"
                            ...
                            <div className="col-md-4">
                                <label className="form-label" style={{ fontFamily: 'Constantia', fontWeight: 'bold' }}>Modèle:</label>
                                <input
                                    type="text"
                                    className="form-control"
                                    value={modelStation}
                            ...
                            <div className="col-md-4">
                                <label className="form-label" style={{ fontFamily: 'Constantia', fontWeight: 'bold' }}>Date de fin de location:</label>
                                <input
                                    type="date"
                                    className="form-control"
                                    value={dateFinLoc}
                            ...
                            <div className="col-md-4">
                                <label className="form-label" style={{ fontFamily: 'Constantia', fontWeight: 'bold' }}>Statut:</label>
                                <select
