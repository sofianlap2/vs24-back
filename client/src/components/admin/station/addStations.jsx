      ...
      <div style={{ display: "flex" }}>
        <div className="row">
          <div style={{ width: "50vw" }}>
            ...
            >
              <h3 style={{ fontWeight: 'bold'}}>Créer une station</h3>
              <br />
              <ToastContainer />
              <div className="col-md-4">
                <label className="form-label" style={{ fontWeight: 'bold'}}>Reference:</label>
                <input
                  type="text"
              ...
              <div className="col-md-4">
                <label className="form-label" style={{ fontWeight: 'bold'}}>Governorate:</label>
                <select
              ...
              <div className="col-md-4">
                <label htmlFor="ville" className="form-label"style={{ fontWeight: 'bold'}}>Ville:</label>
                <select
                  className="form-select"
                  aria-label="Default select example"
              ...
              <div className="col-md-4">
                <label className="form-label" style={{ fontWeight: 'bold'}}>Secteur d'activité:</label>
                <div>
                  <select
                    className="form-select"
                    aria-label="Default select example"
              ...
              <div className="col-md-4">
                <label className="form-label" style={{ fontWeight: 'bold'}}>Espace Public:</label>
                <div>
                  <select
                    className="form-select"
                    aria-label="Default select example"
              ...
              <div className="col-md-4">
                <label className="form-label" style={{ fontWeight: 'bold'}}>Model:</label>
                <input
                  type="text"
                  className="form-control"
                  onChange={(e) =>
              ...
              <div className="col-md-4">
                <label className="form-label"style={{ fontWeight: 'bold'}}>Date fin location:</label>
                <input
                  type="date"
                  className="form-control"
                  onChange={(e) =>
