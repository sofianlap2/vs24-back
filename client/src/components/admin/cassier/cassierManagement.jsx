                ...
                <Box>
                  {cassier.map((c) => (
                    <Box key={c.id} p={2} mb={2} bgcolor={"transparent"} borderRadius="8px" boxShadow={20}>
                      <Typography  variant="h6">{c.locker_number}</Typography>
                      <Typography >Espace Public: {c.espacePublicS}</Typography>
                      <Typography >Secteur Activite: {c.secteurActiviteS}</Typography>
                      <Typography >Gouvernorat: {c.gouvernoratS}</Typography>
                      <Typography >Ville: {c.villeS}</Typography>
                    </Box>
                  ))}
                </Box>
              )}
