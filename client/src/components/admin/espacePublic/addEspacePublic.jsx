  ...
  return (
   ...
   <div style={{ display: 'flex'}}>
      <div  style={{ justifyContent: 'center' }}>
            ...
            <h3 style={{ fontWeight: 'bold'}}>Créer un Espace Public</h3>
          <br />
          <ToastContainer />
              <div                     
              >
                 <label style={{ fontFamily: 'Constantia'}}>
                  Nom Espace:</label>
                  <input type="text" onChange={(e) => setReqBody({ ...reqBody, nomEspace: e.target.value })}  className="form-control"/>
              ...
              <button type="submit"  className="btn btn-success" style={{marginTop:'2vh', fontWeight: 'bold'}}>Add EspacePublic</button>
