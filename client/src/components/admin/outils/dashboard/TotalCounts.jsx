 ...
 fontSize: isMobile?'20px':'20px',
  ...
  return (
    ...
    >
      ...
      <br />
      <p style={{ color: 'red',  fontWeight: 'bold' }}>Espaces publics: </p>
      <h5 style={{  fontWeight: 'bold' }}>{totals.totalEspacesPublics}</h5>
      <p style={{ color: 'green',  fontWeight: 'bold' }}>Stations: </p>
      <h5 style={{  fontWeight: 'bold' }}>{totals.totalStations}</h5>
  </div>
  </div>
